			 ...
			 // $this->load->model('blogquery');
			   ...
			   $this->load->model('menusystem');
			    $this->load->model('pr_models');
				 ...
				 $this->load->model('documentmodels');
   ...
   if(  $this->ck_login() == 1 )
   {
      ...
      // echo br();
       ...
       //echo br();
          ...
          echo $iss_passport=trim($this->input->get_post('iss_passport'));
          echo br();
       //echo $conv_iss_passport=convert_eng_DMY($iss_passport);
      
          
      echo $exp_passport=trim($this->input->get_post('exp_passport'));
       echo br();
       //echo  $conv_exp_passport=convert_eng_DMY($exp_passport);
        ...
        echo $iss_visa=trim($this->input->get_post('iss_visa'));
        //echo  $conv_iss_visa=convert_eng_DMY($iss_visa);
        echo br();
        
        
        
      echo  $exp_visa=trim($this->input->get_post('exp_v'));
       // echo $conv_exp_visa=convert_eng_DMY($exp_visa);
        ...
        echo  $register_date=trim($this->input->get_post('register_date'));
          //echo $conv_register_date=convert_eng_DMY($register_date);
          echo br();
          
         echo  $next_register_date=trim($this->input->get_post('next_register_date'));
          ...
          //echo br();
            ...
            echo $start_work_date=trim($this->input->get_post('start_work_date'));
          //echo  $conv_start_work_date=convert_eng_DMY($start_work_date);
           ...
           //echo br();
             ...
             echo $iss_date_workpermit=trim($this->input->get_post('iss_date_workpermit'));
             //echo $conv_iss_date_workpermit=convert_eng_DMY($iss_date_workpermit);
             echo br();
             
            echo $exp_date_workpermit=trim($this->input->get_post('exp_date_workpermit'));
            // echo $conv_exp_date_workpermit=convert_eng_DMY($exp_date_workpermit);
             ...
             echo $date_signup=trim($this->input->get_post('date_signup'));
       ...
       */
       ...
       $data=array(
          ...
          'iss_passport'=>$iss_passport, //$iss_passport
          ...
          'next_register_date'=>$next_register_date,    //  $conv_next_register_date  
          
          'hm_code'=>$hm_code,
          
          'line_section'=>$line_section,
          
          'start_work_date'=>$start_work_date, //  $conv_start_work_date
          
          
          'work_permit'=>$work_permit,
          
          'iss_date_workpermit'=>$iss_date_workpermit, //  $conv_iss_date_workpermit
          
          
          'exp_date_workpermit'=>$exp_date_workpermit, //   $conv_exp_date_workpermit
          
          'number_social_security'=>$number_social_security,
          
          'date_signup'=>$date_signup,  //   $conv_date_signup
...
function  search_employee()//ค้นหาพนักงาน
{
if(  $this->ck_login() == 1 )
     {
           $id_=trim($this->input->get_post('id_tb_person'));
          $ex=  explode('-',$id_);
          $id_employee=$ex[0];
          if( $id_employee >= 1 )
          {
               ...
               $data['content']="person/tb_employee";
                $data['title']=$this->title;
                 ...
                 // $data['query']=$this->db->get($tb);
                  $data['query']=$this->db->get_where($tb,array('id_employee'=>$id_employee));
                  $data['numrows']=$data['query']->num_rows();
                    $this->load->view('home',$data);   //โหลดหน้าหลัก   
          }
          else
          {
              redirect('home/show_employee');
          }
    }
  else
  {
...
{//begin
    if(  $this->ck_login() == 1 )
     {  
            ...
            {
               $tb="tb_employee";               
               $check=$this->db->get_where($tb,array('id_employee'=>$id_employee));
               if(  $check->num_rows()  > 0 )
               {
                     // $check->num_rows();            
                     $row=$check->row();
                     ...
                     $data['cur_date']=convert_eng_format($cur_date);
                     
                  
                     
                     
                     $iss_passport=$row->iss_passport;//PASS Iss. (วันที่ออกพาสปอร์ต ) :
                     $data['iss_passport']=convert_eng_format($iss_passport);
                     //echo br();
                     $exp_passport=$row->exp_passport;//PASS Exp. (วันที่หมดอายุพาสปอร์ต ) :
                      $data['exp_passport']=convert_eng_format($exp_passport);
                     $data['passport']=MY_cal_date_expire_concept($cur_date,$exp_passport); 
                     //echo br();
                       $data['use_1']=MY_cal_date_expire_concept( $iss_passport,$cur_date); 
                     
                     $iss_visa=$row->iss_visa; //VISA Iss. (วันที่ออกวีซ่า )
                     $data['iss_visa']=convert_eng_format($iss_visa);
                     $exp_visa=$row->exp_visa; //VISA Exp. (วันที่หมดอายุวีซ่า )
                      $data['exp_visa']=convert_eng_format($exp_visa);
                     $data['visa']=MY_cal_date_expire_concept($cur_date,$exp_visa); 
                     //echo br();
                     $data['use_2']=MY_cal_date_expire_concept($iss_visa,$cur_date); 
                     
                     $register_date=$row->register_date; //90 Report Date. (วันที่รายงานตัว
                      $data['register_date']=convert_eng_format($register_date);
                     $next_register_date=$row->next_register_date; //Next 90 Report Date. (วันที่รายงานตัว )
                     $data['next_register_date']=convert_eng_format($next_register_date);
                     $data['register']=MY_cal_date_expire_concept($cur_date,$next_register_date); 
                     //echo br();
                     $data['use_3']=MY_cal_date_expire_concept($register_date,$cur_date); 
                     
                     $iss_date_workpermit=$row->iss_date_workpermit;
                      $data['iss_date_workpermit']=convert_eng_format($iss_date_workpermit);
                     $exp_date_workpermit=$row->exp_date_workpermit;
                      $data['exp_date_workpermit']=convert_eng_format($exp_date_workpermit);
                     $data['workpermit']=MY_cal_date_expire_concept($cur_date,$exp_date_workpermit);
                     $data['use_4']=MY_cal_date_expire_concept($iss_date_workpermit,$cur_date); 
                     
                      $data['title']=$this->title;                      
                      $this->load->view('person/detail_date_expire',$data);           
...
function del_employee()//delete tb_employee
{
 if(  $this->ck_login() == 1 )
     {
            echo $id_employee=trim($this->uri->segment(3));
            if( $id_employee > 0 )
            {
                 $tb="tb_employee";
                 $id="id_employee";                               
                 $this->db->delete($tb, array( $id =>$id_employee));                           
            }
            //http://localhost/hnbase/index.php/home/show_employee   
            redirect('home/show_employee');
     }
  else
  {
...
{//begin
     ...
     { 
      ...
      $number_social_security=trim($this->input->get_post('number_social_security'));
       ...
       //echo br();
        ...
        //$conv_iss_passport=convert_eng_DMY($iss_passport);                          
                                 $f_name="iss_passport";
                                 $v_name=$iss_passport; //  $conv_iss_passport
                                 $id_update="id_employee";
                                 $id_value=$id_employee;                         
        if(  $iss_passport  != ""   )   
           {  
      ...
      $exp_passport=trim($this->input->get_post('exp_passport'));  //exp_passport   
     
       //$conv_exp_passport=convert_eng_DMY($exp_passport);
                                 $f_name="exp_passport";
                                 $v_name=$exp_passport; // $conv_exp_passport
                                 $id_update="id_employee";
                                 $id_value=$id_employee;   
     //echo br();                                                  
        if(  $exp_passport   !=   ""   )    
       ...
       // echo br();
          ...
          //$conv_register_date=convert_eng_DMY($register_date);
                                 ...
                                 $v_name=$register_date; //$conv_register_date
                                 $id_update="id_employee";
                                 $id_value=$id_employee;                      
        if( $register_date   != ""   )   
           {  
          ...
          //next_register_date
                                 ...
                                 $v_name=$next_register_date; //$conv_next_register_date;
                                 $id_update="id_employee";
                                 $id_value=$id_employee;                      
        if( $next_register_date  != ""   )   
           {  
                $this->documentmodels->date_update($tb,$f_name,$v_name,$id_update,$id_value);    
           }  
          //echo br();
          ...
          //start_work_date
                                 ...
                                 $v_name= $start_work_date; //$conv_start_work_date;
                                 $id_update="id_employee";
                                 $id_value=$id_employee;                      
        if( $start_work_date  != ""   )   
           {  
                //$this->documentmodels->date_update($tb,$f_name,$v_name,$id_update,$id_value);
                // $this->documentmodels->update_dmy(); 
                $f_name="id_employee";
                
                //$this->documentmodels->update_dmy($tb,'id_employee',$id_employee); 
                $this->documentmodels->update_dmy($tb,'id_employee',$id_employee,'start_work_date',$start_work_date);  
           }  
           //echo br();
             ...
             //iss_date_workpermit
                                 ...
                                 $v_name= $iss_date_workpermit; // $conv_iss_date_workpermit;
                                 $id_update="id_employee";
                                 $id_value=$id_employee;                      
        if(   $iss_date_workpermit  != ""   )   
           {  
                $this->documentmodels->date_update($tb,$f_name,$v_name,$id_update,$id_value);    
           }  
             //echo br();
             ...
             //exp_date_workpermit
                                 ...
                                 $v_name= $exp_date_workpermit; //$conv_exp_date_workpermit;
                                 $id_update="id_employee";
                                 $id_value=$id_employee;                      
        if(  $exp_date_workpermit != ""   )   
           {  
                $this->documentmodels->date_update($tb,$f_name,$v_name,$id_update,$id_value);    
           }  
             //echo br();
              ...
              //date_signup
                                 $f_name="date_signup";
                                 $v_name= $date_signup; //$conv_date_signup;
                                 $id_update="id_employee";
                                 $id_value=$id_employee;                      
        if(  $date_signup != ""   )   
           {  
...
function check_date()//นับจำนวนวันที่เหลือ
   ...
   if(  $this->ck_login() == 1 )
     {       
           $iss_passport=trim($_POST['iss_passport']);//format = 02/17/2014          
           $exp_passport=trim($_POST['exp_passport']);//format=02/12/2014   
           //echo   MY_cal_date_expire($iss_passport,$exp_passport); 
           echo  MY_cal_date_expire_concept($iss_passport,$exp_passport); 
      }
  else
  {
         redirect('home/page_login');
...
function check_date2()//นับจำนวนวันที่เหลือ
{//begin function
              
   if(  $this->ck_login() == 1 )
     {       
           $begin=trim($_POST['begin']);//format = 02/17/2014          
           $end=trim($_POST['end']);//format=02/12/2014   
           //echo   MY_cal_date_expire($iss_passport,$exp_passport); 
           echo  MY_cal_date_expire_concept($begin,$end); 
      }
  else
  {
         redirect('home/page_login');
              ...
              // echo br();
                 ...
                 //echo br();                
                  // $data['exp_visa']=convert_thai_DMY($exp_visa); //VISA Exp. (วันที่หมดอายุวีซ่า ) :
                   ...
                   $data['next_register_date']=$next_register_date;
                      
                                       
                 //echo  $start_work_date=$row->start_work_date;//Start Work Date (วันที่เข้าทำงาน ) :
                 //echo br();
                  ...
                  // $iss_date_workpermit=$row->iss_date_workpermit; //Work Permit Iss. Date (วันที่ขออนุญาตทำงน ) :
                   $data['iss_date_workpermit']=$row->iss_date_workpermit;                    
