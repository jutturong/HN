...
class Backoffice extends CI_Controller {
	...
	function  test()//ใช้สำหรับทดสอบ code ต่าง
	{
	      
			 $this->load->view('test');
	}
	function receive_test()//ใช้รับค่า receive test  ในหน้าเขียน code ทดสอบ
	{
...
function   admin_menu() //รายการ  backoffice  admin menu
{
			...
			{	 //if    ck
						   $id_menu=$this->uri->segment(3);
							...
							$r_status=$this->uri->segment(5); //จะมีการแสดงสถานะการ udpate ข้อมูล  และการ  insert ข้อมูล
							
							
							if( $r_status != '' ) //	$r_status=$this->uri->segment(5);
							{
							       switch($r_status)
								   {
								              case 1:  //แก้ไข   left menu
											  {
											         		$data['status']=1;  //"insert_success";
											      break;
											  }
											  case 2: //update  left menu
											  {
														   $data['status']=2;    //"update_success";
											     break;
											  }
											  case 3: //mai  menu  insert
											  {
											                 $data['status']=3;
											     break;
											  }
											  case  4: // main menu  update ,delete
											  {
											                 $data['status']=4;
											       break;
											  }
							...
							if( strlen($r_segment) > 0 )//	$r_segment=$this->uri->segment(4)
								...
								case 1: //ข่าวสาร (NEWS)
											...
											case 3: //MENU
											{
																	...
																	$data['max_tab']=2;
																		 ...
																		 $data['tab2']="Main Menu";
																	     //##--   load menu จาก --
																	    $data['tab1_content']="admin/leftmenu/left_menuadmin_tab"; //load sub menu 	 ตัวนี้เป็น file
																		 // $data['tab2_content']="ทดสอบ2";	
																		 $data['sub_main_menu1']="+ เพิ่ม Head Main Menu";   //dynamic
																		 $data['link_sub_main_menu1']="backoffice/admin_menu/3/3"; //dynamic
																		  $data['sub_main_menu2']="+ แก้ไข / ลบ (แสดงเนื้อหาทั้งหมด)"; //dynamic
																		  $data['link_sub_main_menu2']="backoffice/admin_menu/3/5"; //dynamic
																		  
																		  $data['sub_main_menu1_tab2']="+ เพิ่ม  Main Menu";   //dynamic
																		 $data['link_sub_main_menu1_tab2']="backoffice/admin_menu/3/3"; //dynamic
																		  $data['sub_main_menu2_tab2']="+ แก้ไข / ลบ (แสดงเนื้อหาทั้งหมด)"; //dynamic
																		  $data['link_sub_main_menu2_tab2']="backoffice/admin_menu/3/5"; //dynamic
