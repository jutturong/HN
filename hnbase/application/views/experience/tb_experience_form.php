...
<body>
     ...
     <?PHP //$this->tableQuerymodel->form_search('tb_experience');?>
     <?PHP $this->tbload->form_search('tb_experience'); ?>
     ...
     ?>
<?php //$this->tableQuerymodel->tb_experience_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete)?>   
<?php $this->tbload->tb_experience_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete)?> 
