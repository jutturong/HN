...
<body>
     <?=form_open('experience/insert_file')?>
    ...
    <div>
        <ul>
            ...
            <textarea style="width:80%; height:10%"  id="count_experience" name="count_experience" ></textarea>
            </li>
 
            <li>
            ทำงานที่ไหนมาก่อน :
            <input type="text"  maxlength="20"  style="width:50%" id="before_workplace" name="before_workplace" value="" />
            </li>
            
            <li>
            ทำงานที่ไหนมาก่อน (ทำงานที่เดิม):
            <input type="text"  maxlength="20"  style="width:50%" id="workplace"  name="workplace"  value="" />
            </li>

            <li>
            ประเภทงาน:
            <input type="text"  maxlength="20"  style="width:100%" id="work_type"  name="work_type" value="" />
            </li>
            
            <li>
            จำนวน (ปี):
            <input type="text"  maxlength="20"  style="width:10%" id="count_year"  name="count_year" value="" />
            </li>
