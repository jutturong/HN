...
<body>
 <?PHP //$this->tableQuerymodel->form_search('tb_authorization'); ?>  
    <?=$this->tbload->form_search('tb_authorization')?>  
     <?=nbs(2)?>
     select pages :
     <?
    ...
    // $this->tableQuerymodel->page_table($tb,$limit_list,$name_select,$send_page);
     ...
     ?>
<?PHP //$this->tableQuerymodel->tb_authorization_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete)?>   
<?PHP $this->tbload->tb_authorization_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete);?>   
