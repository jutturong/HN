...
<body>    
<?php //$this->tableQuerymodel->form_search('tb_passport')?>     
  <?=$this->tbload->form_search('tb_passport')?>     
    ...
    // $this->tableQuerymodel->page_table($tb,$limit_list,$name_select,$send_page);
     ...
     ?>
<?php $this->tbload->tb_passport_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete)?>   
<?php  //$this->tbload->tb_relation_person_models($query_relation_person,$fieldset_relation);  ?> 
