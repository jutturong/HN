   ...
   <?PHP //echo  form_fieldset(''.$fieldset.''); ?>
    ...
    <div>
        <ul>
            ...
            <input type="text" name="datepicker"  id="datepicker"  maxlength="20"  style="width:20%" />
            </li>
            ...
            <li>
            สถานที่ออกวีซ่า : 
            <input type="text" name="datepicker"  id="datepicker"  maxlength="20"  style="width:50%" />
            </li>

            <li>
            วันที่วีซ่า หมดอายุ  : 
            <input type="text" name="datepicker2"  id="datepicker2"  maxlength="20"  style="width:20%" />
            </li>
            
            <li>
            วันที่ออกวีซ่า : 
            <input type="text" name="datepicker3"  id="datepicker3"  maxlength="20"  style="width:20%" />
            </li>
            
            <li>
            วันที่รายงานตัวครั้งล่าสุด : 
            <input type="text" name="datepicker4"  id="datepicker4"  maxlength="20"  style="width:20%" />
            </li>
