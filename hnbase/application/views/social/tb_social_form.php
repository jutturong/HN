...
<body>
   <?=$this->tableQuerymodel->form_search('tb_social_security')?>   
     <?=nbs(2)?>
     select pages :
     <?
     ...
     ?>
<?=$this->tableQuerymodel->tb_social_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete)?>   
