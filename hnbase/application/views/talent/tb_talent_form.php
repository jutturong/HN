...
<body>
      ...
      <?PHP //$this->tableQuerymodel->form_search('tb_talent'); ?>
    <?PHP $this->tbload->form_search('tb_talent'); ?>
     ...
     ?>
<?PHP //$this->tableQuerymodel->tb_talent_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete); ?>  
<?PHP $this->tbload->tb_talent_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete); ?>  
