...
<?PHP 
     // $this->tbload->tb_person_models($query)
?> 
 ...
 <? 
     ...
     <?=$this->tbload->form_search('tb_person');//สำหรับการค้นหาชื่อของพนักงาน?>
...
<?PHP //$this->tableQuerymodel->tb_person_models_link($query_relation_person,$send_page);?>   
<?PHP $this->tbload->tb_person_models_link($query_relation_person,$send_page);?> 
