...
<body>
    ...
    <?PHP //$this->tableQuerymodel->form_search('report');//สำหรับการค้นหาชื่อของพนักงาน ?>
    <?PHP $this->tbload->form_search('report');//สำหรับการค้นหาชื่อของพนักงาน?>
     ...
     ?>
     <?PHP //$this->tableQuerymodel->tb_report_models_link($query_relation_person,$send_page,$link_report); ?>   
     <?PHP $this->tbload->tb_report_models_link($query_relation_person,$send_page,$link_report); ?> 
