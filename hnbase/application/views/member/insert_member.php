	         ...
	         {  
					  ...
					  {   
							...
							if( status )
							{
									 ...
									 //  window.location='<?=base_url()?>index.php/member/member_menu/5';
							}
					   })
...
<td width="284"><input name="name" type="text" id="name"  style="width:40%" size="10" maxlength="20">
   - <input name="lastname" type="text" id="lastname" style="width:50%" size="10" maxlength="20"/></td>
</tr>
<tr>
<td>Username : </td>
<td><input name="user" type="text" id="user"  style="width:35%" size="10" maxlength="20"></td>
</tr>
<tr>
<td>Password : </td>
<td><input name="password" type="text" id="password"  style="width:35%" size="10" maxlength="20"></td>
</tr>
<tr>
<td>วัน-เดือน-ปี เกิด : </td>
<td><input name="birthday" type="text" id="birthday"  style="width:35%" size="10" maxlength="20"></td>
</tr>
<tr>
<td>Email : </td>
<td><input name="email" type="text" id="email"  style="width:50%" size="10" maxlength="20"></td>
</tr>
<tr>
<td>อนุญาติ : </td>
<td><input name="user_enable" type="checkbox" value="1" id="user_enable" checked="checked" /></td>
</tr>
<tr>
<td>ระดับผู้ใช้ : </td>
<td>
...
<td><input name="id_card" type="text" id="id_card" style="width:50%" size="20" maxlength="13" /> </td>
</tr>
<tr>
<td>ที่อยู่ : </td>
<td><input name="address" type="text" value="khonkaen" style="width:70%" id="address" /> </td>
</tr>
