...
<body>
     ...
     <? //$this->tableQuerymodel->form_search('tb_experience')?>           
     <?
     // $name_select="redirect_page"; 
     //$this->tableQuerymodel->page_table($tb,$limit_list,$name_select,$send_page);
     ?>
    
<?PHP //$this->tableQuerymodel->tb_member_models_link($field_set,$tb_user)?>  
    <?PHP  $this->tbload->tb_member_models_link($field_set,$tb_user); ?> 
