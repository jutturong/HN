...
<? //$this->tableQuerymodel->tb_person_models($query)?> 
    <?PHP //echo $send_page;  ?>
    <?php  //$this->tableQuerymodel->form_search('tb_document'); ?>
     <?php  $this->tbload->form_search('tb_document'); ?>
     ...
     ?>
<?PHP //$this->tableQuerymodel->tb_document_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete)?>   
<?PHP  $this->tbload->tb_document_models_link($query_relation_person,$send_page,$field_set,$field_name,$tb_check,$link_operator,$link_update,$link_delete)?>   
