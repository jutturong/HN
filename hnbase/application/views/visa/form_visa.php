...
<script type="text/javascript">
				$(function() {
							$( "#date_visa_expire_begin" ).datepicker({
							changeMonth: true,
							changeYear: true,
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#check").click(function(){
            $.ajax({
                    //url: "bad-word.php",
                    url: "<?=base_url()?>index.php/visa/check_date",
                    //data: {inputword : $("#inputword").val()},
                    //data: {inputword : 55 },
                    data:{ date_visa_expire_begin : $('#date_visa_expire_begin').val(),date_visa_expire : $('#date_visa_expire').val() },
 ...
 <?=form_open('visa/insert_file')?>  
    <div>
        <ul>
            ...
            <li>
            วันที่วีซ่า หมดอายุ (ใหม่) : 
            <input type="text" name="date_visa_expire_begin"  id="date_visa_expire_begin"  maxlength="20"  style="width:20%" />
            </li>
            
            <li>
            วันที่วีซ่า หมดอายุ  : 
            <input type="text" name="date_visa_expire"  id="date_visa_expire"  maxlength="20"  style="width:20%" />
            </li>
             ...
             <input type="text" name="count_date_visa"  id="count_date_visa"  maxlength="3"   style="width:10%"  />
            ...
            <li>
            สถานที่ออกวีซ่า : 
            <input type="text" name="place_visa"  id="place_visa"  maxlength="20"  style="width:50%" value="" />
            </li>
            ...
            <li>
            วันที่ออกวีซ่า : 
            <input type="text" name="date_visa"  id="date_visa"  maxlength="20"  style="width:20%" />
            </li>
